[![Build Status](https://travis-ci.org/ublaboo/datagrid-nette-database-data-source.svg?branch=master)](https://travis-ci.org/ublaboo/datagrid-nette-database-data-source)
